...
const Main = () => {
  return(
    <main className='main'>
    <ul>
      <li>Срочное сообщение! С компьютера игрока команды Tundra Crystallis замечено странное соединение, анализ IP показал, что из будки ГУЛЯЭ Елена «Мопс» Головач</li>
      <li>Срочное сообщение! С компьютера игрока команды Tundra Crystallis замечено странное соединение, анализ IP показал, что из будки ГУЛЯЭ Елена «Мопс» Головач</li>
      <li>Срочное сообщение! С компьютера игрока команды Tundra Crystallis замечено странное соединение, анализ IP показал, что из будки ГУЛЯЭ Елена «Мопс» Головач  </li>
    </ul>
